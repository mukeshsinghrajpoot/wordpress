            ...
            action: 'getcoin_curl_responce'
             ...
             success: function(data) {
               ...
               if(balance_coins >= wordpress_fixed_coins)
               {
                ...
                jQuery("#blance_coin").html("<div class='coinvalue'>"+balance_coins+'</div>');
              }else
              {
                jQuery("#readmore").hide();
                jQuery("#byecoins").show();
                jQuery("#buy_coin").html("<div class='coinvalue'>"+balance_coins+'</div>');
              }
            ...
            action: 'articles_curl_responce'
             ...
             success: function(data) {
              ...
              var message=data1.message;
               if (status=="failure")
               {
                  jQuery("#resulted").html('<p style="color:red;">'+message+'</p>');
                 jQuery("#resulted").fadeTo(2000, 500).slideUp(500, function(){
                 jQuery("#resulted").slideUp(500);
                });
               }else
               {
                if(is_purchased)
