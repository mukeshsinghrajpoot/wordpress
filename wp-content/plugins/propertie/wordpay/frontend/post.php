  ...
  if ( is_singular($post) ) 
  {
    ...
    elseif ($production=='1')
    {
     ...
     ?>
                    ...
                    <div class="div2" id="readmore" style="display: none;">
                        <h1 id="resulted"></h1>
                        <div class="box2">
                            <?php 
				              $query = new WP_Query(array(
				               ...
				               'post_type' => 'price-range',
                                ...
                                <span class="coins"><?php echo $fixedprice ?> coins</span>
                                <span class="coinsb"><img class="imgfaicon" src="<?PHP echo plugin_dir_url( dirname( __FILE__ ) ) . 'frontend/bootstrap/signin-signup/imgs/3.png'?>"><wordpay id='blance_coin'></wordpay></span>
                                <a href="javascript:void(0)" class="btn-gradient" onClick="validatCoin(1)">
                                    <span class="lastlogo"><img class="readimgsize" src="<?PHP echo plugin_dir_url( dirname( __FILE__ ) ) . 'frontend/bootstrap/signin-signup/imgs/4.png'?>">
              </span>
                                </a>
                        </div>
                        <center><div class="sign-up mb-4 mt-4 text-uppercase">
                    ...
                    <div class="div1" id="byecoins" style="display: none;">
                        <h1 id="result"></h1>
                        <div class="box1">
                            <span class="coins"><?php echo $fixedprice ?> coins</span>
                            <span class="coinsb">
        <img class="imgfaicon" src="<?PHP echo plugin_dir_url( dirname( __FILE__ ) ) . 'frontend/bootstrap/signin-signup/imgs/3.png'?>"><wordpay id='buy_coin'></wordpay>
      </span>
                            <a href="#" target="_blank" class="btn-gradient">
                                <span class="buycoins">BUY COINS</span>
                            </a>
                        </div>
                        <center>
